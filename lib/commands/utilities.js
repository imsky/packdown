 ...
 * @param {String} file - path to file
 */
exports.isBinaryFile = function isBinaryFile (file) {
 ...
 */
exports.dasherize = function dasherize (filename) {
  var props = path.parse(filename);

  return path.join(props.dir, changeCase.paramCase(props.name) + props.ext);
};
