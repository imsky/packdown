...
(function () {
  ...
  var grammar = {
    ParserRules: [
      {
        "name": "Document",
        "symbols": ["DocHeader", "DocInfo", "FileList", "Document$ebnf$1"],
      ...
      {
        "name": "Metadata",
        "symbols": ["Metadata$string$1", "int", {
          "literal": "-"
        }, "SemVer", "Metadata$string$2", "NL"],
        "postprocess": function (d) {
          return {
            formatVersion: d[1],
            packageVersion: d[3]
      ...
      {
        "name": "FileHeader",
        "symbols": ["FileHeader$string$1", "PathText", {
          "literal": "\n"
        }],
        "postprocess": function (d) {
          return d[1];
